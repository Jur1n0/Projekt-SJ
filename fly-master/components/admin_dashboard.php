<?php
session_start();
// Zabezpečenie: Iba prihlásení používatelia s rolou 'admin' majú prístup
...
try {
    ...
    $stmt = $user_obj->readAll(); // Metóda readAll vráti PDOStatement
    ...
    <main id="admin-dashboard-page" class="main-content">
        <div class="admin-container">
            ...
            <table>
                ...
                <?php if (empty($users)): ?>
                    <tr>
                        <td colspan="6">Žiadni používatelia v databáze.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td class="action-buttons">
                                <button class="btn-edit" onclick="openEditModal(<?php echo $user['id']; ?>, '<?php echo htmlspecialchars($user['first_name'], ENT_QUOTES); ?>', '<?php echo htmlspecialchars($user['last_name'], ENT_QUOTES); ?>', '<?php echo htmlspecialchars($user['email'], ENT_QUOTES); ?>', '<?php echo htmlspecialchars($user['role'], ENT_QUOTES); ?>')">Upraviť</button>
